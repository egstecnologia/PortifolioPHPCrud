        ...
        <div class="container-form">
            <form class="row g-3 mold-1">
                ...
                <div>
                    ...
                    <div class="al-2">
                        <div class="col-md-5">
                            <input type="text" class="form-control form-hgt" id="inputCodCli" placeholder="Digitar código do cliente">
                        </div>
                        <div>
                            <span class="input-group-btn col-md-2 ">
                            <button class="btn-img2 form-hgt" type="button" id="pesquisaProfissional"><img
                    ...
                    <div class="al-2">
                        <div class="col-md-5">
                            <input type="text" class="form-control form-hgt" id="inputTel" placeholder="Digitar numero do telefone">
                        </div>
                    ...
                    <div class="al-2">
                        <div class="col-md-5">
                            <input type="text" class="form-control form-hgt" id="inputRede" placeholder="Digitar endereço de rede social">
                        </div>
                        <div class="col-md-2 btn-busca"></div>
                    </div>
                    ...
                    <div class="al-2">
                        <div class="col-md-5">
                            <input type="email" class="form-control form-hgt" id="inputEmail" placeholder="Digitar endereço de e-mail">
                        </div>
                        <div class="col-md-2 btn-busca"></div>
                    </div>
