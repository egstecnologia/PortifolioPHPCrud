            ...
            <div class="container-form">
                <form class="row g-3 mold-1">
                    ...
                    <div>
                        ...
                        <div class="al-2">
                            <div class="col-md-5">
                                <input type="text" class="form-control form-hgt" id="inputCodPro" placeholder="Digitar código do profissional">
                            </div>
                            <div>
                        ...
                        <label for="inputForPgto" class="form-label"></label>
                        <div class="al-2">
                            <div class="col-md-5">
                                <input type="text" class="form-control form-hgt" id="inputForPgto" placeholder="Digitar tipo de pagamento">
                            </div>
                            <div class="col-md-2 btn-busca">
