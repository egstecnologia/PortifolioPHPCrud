...
-- Copiando dados para a tabela projeto_full.categorias: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela projeto_full.categoria_servico: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela projeto_full.cidades_atend: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela projeto_full.clientes: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela projeto_full.contatos: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela projeto_full.dias_horas: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela projeto_full.enderecos: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela projeto_full.formas_recebimentos: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela projeto_full.fotos_servicos: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela projeto_full.perguntas: ~4 rows (aproximadamente)
INSERT INTO `perguntas` (`id`, `nome`, `email`, `titulo`, `mensagem`) VALUES
	(1, 'Eric Gti Sis', 'ericgaldino@gtigrupo.com.br', 'A procura 2', 'ww'),
	(2, 'Eric Gti Sis', 'ericgaldino@gtigrupo.com.br', 'A procura 2', 'ww'),
	(3, 'Eric Gti Sis', 'ericgaldino@gtigrupo.com.br', 'Eric Gti Sis', 'Eric Gti Sis'),
	(4, 'Eric Gti Sis', 'ericgaldino@gtigrupo.com.br', 'A procura 2', 'Eric Gti Sis'),
	(5, 'GDelivery App ', 'eric.fullmetal@gmail.com', 'ss', 'FD'),
	(6, 'GDelivery App ', 'eric.fullmetal@gmail.com', 'ss', 'S');
...
-- Copiando dados para a tabela projeto_full.profissionais: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela projeto_full.usuario: ~0 rows (aproximadamente)
INSERT INTO `usuario` (`id`, `login`, `senha`) VALUES
	(1, 'ericgaldino@gmail.com', '$2y$10$l5/0y1tpBA0kBQNHpcBnweiiW92JrmIRDJ79CvzQ4WLusrK/Njwly');
