                ...
                <form class="row g-3 mold-1">
                    ...
                    <div>
                        <div>
                            ...
                            <div class="al-2">
                                <div class="col-md-5">
                                    <input type="text" class="form-control form-hgt" placeholder="Pesquisar código do profissional">
                                </div>
                                <div>
                            ...
                            <div class="al-2">
                                <div class="col-md-5">
                                    <input type="text" class="form-control form-hgt" placeholder="Pesquisar código do cliente">
                                </div>
                                <div>
                                    <span class="input-group-btn col-md-2 ">
                                        <button class="btn-img2 form-hgt" type="button" id="pesquisaProfissional"><img src="src/img/lupa.png" style="max-widht:28px; max-height:28px;"></button>
                            ...
                            <div class="al-2">
                                <div class="col-md-5">
                                    <input type="text" class="form-control form-hgt" placeholder="Pesquisar codigo do serviço">
                                </div>
                                <div>
                                    <span class="input-group-btn col-md-2 ">
                                        <button class="btn-img2 form-hgt" type="button" id="pesquisaProfissional"><img src="src/img/lupa.png" style="max-widht:28px; max-height:28px;"></button>
